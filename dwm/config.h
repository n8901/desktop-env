...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_equal,  spawn,	   SHCMD("amixer -q sset Master 5%+")},
	{ MODKEY|ShiftMask,		XK_minus,  spawn,	   SHCMD("amixer -q sset Master 5%-")},
	{ MODKEY|ShiftMask,		XK_m,	   spawn,	   SHCMD("amixer -q sset Master toggle")},
